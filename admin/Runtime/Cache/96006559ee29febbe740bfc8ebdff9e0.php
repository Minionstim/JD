...
//	  }
  ...
  hello();
      ...
      <div class="rightDiv">
<table border="1" bgcolor="gray" align="center" width="300">
    <tr>
      <td colspan="3"  ><a href="__APP__/News/add/cid/<?php echo ($_GET['cid']); ?>">添加文章</a></td>
    </tr>
	<tr>
	...
	<?php if(is_array($arr)): foreach($arr as $key=>$v): ?><tr>
		...
		<td align="center"><a href="__APP__/News/update/id/<?php echo ($v["id"]); ?>">修改</a>&nbsp;|&nbsp;<a href="__APP__/News/del/id/<?php echo ($v["id"]); ?>">删除</a></td>
