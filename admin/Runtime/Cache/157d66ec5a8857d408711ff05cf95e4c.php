...
//	  }
  ...
  hello();
      ...
      <div class="rightDiv">
<table border="1" bgcolor="gray" align="center"  width="600">
    <tr>
      <td colspan="3"  ><a href="__APP__/Product/add/cid/<?php echo ($_GET['cid']); ?>">添加产品</a></td>
    </tr>
	<tr>
	...
	<?php if(is_array($arr)): foreach($arr as $key=>$v): ?><tr>
		...
		<td align="center"><?php echo ($v["brand"]); ?></td>
		<td align="center"><?php echo ($v["price"]); ?></td>
		<td align="center"><?php echo ($v["userprice"]); ?></td>
		<td align="center"><?php echo ($v["content"]); ?></td>
		<td align="center"><?php echo ($v["guige"]); ?></td>
		<td align="center"><a href="__APP__/Product/update/id/<?php echo ($v["id"]); ?>">修改</a>&nbsp;|&nbsp;<a href="__APP__/Product/del/id/<?php echo ($v["id"]); ?>">删除</a></td>
