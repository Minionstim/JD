...
<li><a href="__APP__" class="cur">首页</a></li>
 ...
 <li><a href="../productList.html"  target="_blank" >运动健康</a></li>
 <li><a href="../productList.html" target="_blank"  >汽车用品</a></li>
 <li><a href="../productList.html" target="_blank"  >展销会专栏</a></li>
...
<div class="blank"></div>
  ...
  <script type="text/javascript" src="__PUBLIC__/js/showdiv.js"></script>  <script type="text/javascript">
  ...
  <div class="flow_tou">
      <img  style="float:left"src="__PUBLIC__/themes/jindong/images/cart_001.gif" />
  ...
  <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#aacded">
    ...
    <?php if(is_array($pArrn)): foreach($pArrn as $key=>$v): ?><tr>
       ...
       <img src="__PUBLIC__/upload/<?php echo ($v["imagename"]); ?>" width="50"/>
       <br />
               <?php echo ($v["pname"]); ?>
       </td>
       <td align="center" bgcolor="#ffffff">￥<?php echo ($v["userprice"]); ?>元</td>
       <td align="center" bgcolor="#ffffff">
       <input type="text" name="number[<?php echo ($v["id"]); ?>]" value="<?php echo ($v["cartnum"]); ?>" size="4" class="inputBg" style="text-align:center " onkeydown="showdiv(this)"/>
       </td>
       <td align="center" bgcolor="#ffffff">￥<?php echo ($v["money"]); ?>元</td>
       <td align="center" bgcolor="#ffffff">
       <a href="javascript:if(confirm('您确实要把该商品移出购物车吗？')) location.href='__APP__/Cart/delete/id/<?php echo ($v["id"]); ?>'; " class="f6">删除</a>
       </td>
        ...
        <table width="99%" align="center" border="0" cellpadding="5" cellspacing="0" bgcolor="#aacded">
          <tr>
            <td bgcolor="#ffffff" style="padding:20px;0"><a href="./"><img style="vertical-align:middle;" src="__PUBLIC__/themes/jindong/images/jixubuy.gif" /></a>&nbsp;&nbsp;&nbsp;&nbsp;

            
            <input style="vertical-align:middle;"  type="button" value="" class="clear_car" onclick="if(confirm('是否清空购物车')) location.href='__APP__/Cart/clear'" />&nbsp;&nbsp;&nbsp;&nbsp;
            
            
            <input style="vertical-align:middle;" name="submit" type="submit" class="gengxin_car" value="" /></td>
            <td bgcolor="#ffffff" align="right" style="padding:20px;0"><a href="__APP__/Cart/checkout"><img src="__PUBLIC__/themes/jindong/images/checkout.gif" alt="checkout" /></a></td>
          </tr>
        </table>
         </form>
