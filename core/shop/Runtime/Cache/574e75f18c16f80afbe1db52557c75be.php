...
<div class="usBox_in clearfix" style="position:relative">
  ...
  <div class="usBox_1 f_l">
   <form name="formLogin" action="__APP__/User/check" method="post" onSubmit="return userLogin()">
        <table width="100%" border="0" align="left" cellpadding="3" cellspacing="5">
          <tr>
            <td width="15%" align="right">用户名：</td>
            <td width="85%"><input type="hidden" name="url" value="<?php echo ($url); ?>"/>
  ...
  <div class="usTxt" style="position:absolute; TOP:15PX; right:40PX;">
    ...
    3. 享受会员积分制度<br />
    4. 订阅本店商品信息  <br />
    <a href="__APP__/User/register"><img src="__PUBLIC__/themes/jindong/images/bnt_ur_reg.gif" /></a>
  </div>
</div>
