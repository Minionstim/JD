...
<link href="__PUBLIC__/themes/jindong/stye.css" rel="stylesheet" type="text/css" /> <link rel="icon" href="favicon.ico" type="image/x-icon" />
...
<div class="usBox_in "  style="position:relative">
    ...
    <form  action="__APP__/User/adduser" method="post" name="formUser" onsubmit="return register();" style="background:none"> <div class="blank"></div> <div class="blank"></div> <div class="blank"></div>
      <table width="100%"  border="0" align="left" cellpadding="5" cellspacing="3" style="background:none">
        ...
        <tr>
          ...
          <input name="qq" type="text" size="25" class="inputBg" /><span style="color:#FF0000"> *</span>          </td>
        </tr>
			        <tr>
          ...
          <input name="tel" type="text" size="25" class="inputBg" /><span style="color:#FF0000"> *</span>          </td>
        </tr>
			        <tr>
...
<td align="right" >密码问题答案</td>
	  ...
	  <input name="passwd_answer" type="text" size="25" class="inputBg" maxlengt='20'/>          </td>
        ...
        <tr>
          ...
          <input type="hidden" name="back_act" value="" />
           <input name="Submit" type="submit" value="" style=" width:136px; height:35px; border:none; background:url(__PUBLIC__/themes/jindong/images/bnt_ur_reg.gif) no-repeat">
          </td>
        </tr>
        <tr>
          <td colspan="2">&nbsp;</td>
      ...
      </table> <div class="blank"></div> <div class="blank"></div> <div class="blank"></div> <div class="blank"></div>
    </form>
...
<p id="footerNav">
  ...
  <p id="qureyInfo">共执行 8 个查询，用时 0.038363 秒，在线 3 人，Gzip 已禁用，占用内存 4.959 MB<img src="api/cron.php?t=1344196684" alt="" style="width:0px;height:0px;" /></p>
