...
<link href="__PUBLIC__/themes/jindong/stye1024.css" rel="stylesheet" type="text/css" />  
...
<div  style="float:right; color:#acacac; padding-right:15px;">         
   <script type="text/javascript" src="../js/transport.js"></script><script type="text/javascript" src="../js/utils.js"></script>   <font id="ECS_MEMBERZONE">您好，beifang, 欢迎您回来！</span>
<a href="user.php">[会员中心]</a> <a href="user.php?act=logout">[退出]</a>
...
<li><a href="../index.html" class="cur">首页</a></li>
 ...
 <li><a href="../productList.html"  >展销会专栏</a></li>
...
<a href="flow.php"><span>购物车中有<b>1</b>件商品</span>
  ...
  <li>
 <div class="f_l">
 <a class="img" href="goods.php?id=4779"><img src="images/no_picture.gif" style="width:50px; height:50px;" alt="产品20"></a>
 <a class="name" href="goods.php?id=4779">产品20</a>
 </div>
 <div class="f_r">
<b>￥999元×1</b> <br />
<a class="del" href="javascript:" onClick="deleteCartGoods(43)">删除</a>
 </div>
</li>
 <ul>
...
<div class="blank"></div>
        ...
        <form action="__APP__/Cart/success" method="post" name="theForm" id="theForm" onsubmit="">
        <script type="text/javascript">
        var emsJson={1:[20,4000],2:[10,3000]};
        var cartmoney=<?php echo ($money); ?>;//订单的总价钱
        var peisong;
        var baozhuang;
        function huizong(){
        	//获取配送
        	var ob1=document.getElementsByName("ems");
        	for(var i=0;i<ob1.length;i++){
        		if(ob1[i].checked){
        			index=ob1[i].value;
        			arr=emsJson[index];
        			payMoney=arr[0];//费用
        			nopayMoney=arr[1];//免费的额度
        			if(cartmoney>=nopayMoney){
        				document.getElementById("emscart").innerHTML="0.00";
        				 peisong=0;
        			}else{
        				document.getElementById("emscart").innerHTML=payMoney;
        				peisong=payMoney;
        			}
        		}
        	}
        	//获取包装
        	var ob2=document.getElementsByName('pack');
        	for(var i=0;i<ob2.length;i++){
        		if(ob2[i].checked){
        			...
        			if(vn==1){
        				...
        				document.getElementById("alipaycart").innerHTML="0.00";
        				baozhuang=0;
        			}else if(vn==2){
        				if(cartmoney>=800){
        					document.getElementById("alipaycart").innerHTML="0.00";
        					...
        					document.getElementById("alipaycart").innerHTML="5.00";
        					baozhuang=5;
        				}
        			}
        		}
        	}
        	document.getElementById("cartmoney").innerText=cartmoney+peisong+baozhuang;
        }
        </script>
  	...
  	<dl></dl><dt>订单详情</dt><dd></dd>
        ...
        <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#aacded">
            ...
            <?php if(is_array($pArrn)): foreach($pArrn as $key=>$v): ?><tr>
              <td bgcolor="#ffffff">
             	<input type="hidden" name="productprice[<?php echo ($v["id"]); ?>]" value="<?php echo ($v["userprice"]); ?>"/><?php echo ($v["pname"]); ?>
              <td bgcolor="#ffffff" align="center" style=" font-weight:bold; color:#F00">￥<?php echo ($v["userprice"]); ?>元</td>
              <td bgcolor="#ffffff" align="CENTER"><?php echo ($v["cartnum"]); ?></td>
              <td bgcolor="#ffffff" align="right">￥<?php echo ($v["money"]); ?>元</td>
            </tr><?php endforeach; endif; ?>
             <tr>
              <td bgcolor="#ffffff" colspan="7" align="right" style=" color:#FF0000; font-weight:bold">
             
              购物金额小计 ￥<b id="cartmoney"><?php echo ($money); ?></b>元              </td>
            </tr>
                      </table>
      ...
      <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#aacded">
            <tr>
              ...
              <td bgcolor="#ffffff"><input type="text" name="addr"/></td>
              <td bgcolor="#ebf4fb">邮政编码:</td>
              <td bgcolor="#ffffff"><input type="text" name="post"/></td>
            </tr>
                        <tr>
    ...
    <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#aacded" id="shippingTable">
          ...
          <tr>
              <td bgcolor="#ffffff" valign="top"><input onchange="huizong();" name="ems" type="radio" value="1" checked="true" supportCod="0" insure="0" />
              </td>
            ...
            <tr>
              <td bgcolor="#ffffff" valign="top"><input onchange="huizong();" name="ems" type="radio" value="2" checked="true" supportCod="0" insure="0"/>
              </td>
              <td bgcolor="#ffffff" valign="top"><strong>快递 顺丰快递</strong></td>
              <td bgcolor="#ffffff" valign="top">特别快</td>
              <td bgcolor="#ffffff" align="right" valign="top">￥10.00元</td>
              <td bgcolor="#ffffff" align="right" valign="top">￥3000.00元</td>
              <td bgcolor="#ffffff" align="right" valign="top">不支持保价</td>
            </tr>
            <tr>
    ...
    <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#aacded" id="paymentTable">
            ...
            <tr>
              <td valign="top" bgcolor="#ffffff"><input type="radio" name="alipay" value="1"  isCod="0" onclick="selectPayment(this)" /></td>
            ...
            <tr>
              <td valign="top" bgcolor="#ffffff"><input type="radio" name="alipay" value="2"  isCod="1" onclick="selectPayment(this)"/></td>
...
货到付款区域：新疆特区喀什市</td>
            ...
            <tr>
              <td valign="top" bgcolor="#ffffff"><input type="radio" name="alipay" value="3" checked isCod="0" onclick="selectPayment(this)" /></td>
        ...
        <div class="blank"></div>
          ...
          <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#aacded" id="packTable">
            ...
            <tr>
              <td valign="top" bgcolor="#ffffff"><input onchange="huizong();" type="radio" name="pack" value="1" checked="true"/></td>
              ...
              <td valign="top" bgcolor="#ffffff">&nbsp;</td>
                        ...
                        <tr>
              <td valign="top" bgcolor="#ffffff"><input onchange="huizong();" type="radio" name="pack" value="2"/>
              </td>
...
<table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" class="tableList f0_table" style="color:#FF0000">
    ...
    <td align="right" bgcolor="#ffffff">
      商品总价: <font class="f4_b">￥<?php echo ($money); ?>.00元</font>
                        + 配送费用: <font class="f4_b">￥<b id="emscart">10.00</b>元</font>
                        + 包装费: <font class="f4_b">￥<b id="alipaycart">0.00</b>元</font>
                      </td>
  </tr>
    <tr>
    <td align="right" bgcolor="#ffffff"> 应付款金额: <font class="f4_b"><span id="cartmoney">￥1024.00元</span></font>
    	</td>
  </tr>
</table>
</div>           <div align="center" style="margin:8px auto;">
            <input type="image" src="__PUBLIC__/themes/jindong/images/bnt_subOrder.gif" />
