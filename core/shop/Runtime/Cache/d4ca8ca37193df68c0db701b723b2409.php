...
<link href="__ROOT__/Public/themes/jindong/stye1024.css" rel="stylesheet" type="text/css" /> 
...
<a href="flow.php"><script type="text/javascript" src="js/transport.js"></script><span>购物车中有<b>1</b>件商品</span>
  <ul class="car_ul">
  <li>
 <div class="f_l">
 <a class="img" href="goods.php?id=4761"><img src="__ROOT__/Public/images/201208/thumb_img/4761_thumb_G_1344186486336.jpg" style="width:50px; height:50px;" alt="产品1"></a>
...
<div class="p_w" style="clear:both; overflow:hidden"></div>
  ...
  <h3><a href="/cert/index.php">首页</a> <?php echo ($typeStr); ?> <code>&gt;</code> <?php echo ($productArr["pname"]); ?></h3>
</div>
...
<div class="blank"></div>      
    ...
    <div id="globalBigRight">
      ...
      <h2 class="name" style="text-align:center; font-size:16px; font-family:宋体; margin-bottom:8px; font-weight:bold; position: relative"><?php echo ($productArr["pname"]); ?>
      </h2>
      <div id="itemAllInfo" class="globalModule">
      <div id="goodsInfo">
        <div id="itemPic">
          		<a target="_blank" href="__PUBLIC__/upload/<?php echo ($imageArr[0]["path"]); ?>" onclick="window.open('gallery.php?id=4761'); return false;" id="zoom1" class="MagicZoom MagicThumb" rel="zoom-width: 550px; zoom-height: 350px; zoom-position:right">
      <img src="__PUBLIC__/upload/<?php echo ($imageArr[0]["path"]); ?>" style="width:350px; height:350px;" />
	 </a>        
      ...
      <div class="gallery">
        <div id="demo">
          <div id="demo1" style="float:left">
           ...
           <a  href="__PUBLIC__/upload/<?php echo ($v["path"]); ?>"
     rel="zoom1" 
        rev="__PUBLIC__/upload/<?php echo ($v["path"]); ?>"
        title="">
        <img src="__PUBLIC__/upload/<?php echo ($v["path"]); ?>" alt="产品1" class="B_red" /></a>
      ...
      function clickRight() {
        ...
        <form action="__APP__/Cart/add" method="post" id="cartForm" >
		 <ul class="line" >
               								
                        <li style="color:#999;">商品货号：<?php echo ($productArr["id"]); ?></li>
                              <li>商品品牌：<?php echo ($productArr["brand"]); ?></li>
                 
                        <li>市 场 价：<span class="marketPrice">￥<?php echo ($productArr["price"]); ?>元</span></li>
                        <li>美 智 价：<span class="goodsPrice" id="ECS_SHOPPRICE">￥<?php echo ($productArr["userprice"]); ?>元</span></li>
       ...
       <font class="f1">购买商品达到以下数量区间时可享受的优惠价格：</font><br />
			 <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#dddddd">
				<tr>
					...
					<td align="center" bgcolor="#FFFFFF"><strong>优惠价格</strong></td>
								...
								<tr>
					<td align="center" bgcolor="#FFFFFF" class="shop"><?php echo ($productArr["buynum"]); ?></td>
					<td align="center" bgcolor="#FFFFFF" class="shop">￥<?php echo ($productArr["buyprice"]); ?>元</td>
				</tr>
					     </table>
      </li>
        
           
           <li>                 商品库存：<?php if($productArr["num"] > 0): ?>有货<?php else: ?>没有了<?php endif; ?>
              </li>
        ...
        <input type="hidden" name="id" value="<?php echo ($productArr["id"]); ?>"/>
        </li>
      ...
      <ul>
          <li id="itemBtnList">
          	 <img onclick="subForm();" src="__ROOT__/Public/themes/jindong/images/btn_addcart.gif" alt="" />
  ...
  function subForm(){
     ...
     <div class="tab_box">
      ...
      <div id="com_h" class="padd_box">
        <blockquote>
        <?php echo ($productArr["intro"]); ?>
        </blockquote>
        <blockquote>
        <?php echo ($productArr["format"]); ?>
        </blockquote>  
        <blockquote>
