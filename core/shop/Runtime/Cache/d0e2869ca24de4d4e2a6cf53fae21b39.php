...
<link href="__PUBLIC__/themes/jindong/stye.css" rel="stylesheet" type="text/css" /> 
<link rel="icon" href="favicon.ico" type="image/x-icon" />
<link rel="shortcut icon" href="favicon.ico" type="image/x-icon" />
<link rel="icon" href="animated_favicon.gif" type="image/gif" />
<title>京东网上商城-综合网购首选，正品行货，机打发票，售后上门取件，省钱又放心 - Powered by ECShop</title>
  <script type="text/javascript" src="../__PUBLIC__/js/common.js"></script><script type="text/javascript" src="__PUBLIC__/js/index.js"></script>  
...
<DL>
  ...
  <A style="float:right; background:url(__PUBLIC__/themes/jindong/images/biao.gif) 55px center no-repeat; padding-right:23px;display:block; line-height:29px;"  class=alk 
...
<div style="float:right; _padding-top:9px; background: url(__PUBLIC__/themes/jindong/images/nav_bg2.gif) 0 top no-repeat; height:29px; padding-left:28px;">
				<a href="search.php?intro=promotion"  >今日特价</a> <img style="vertical-align:middle" src="__PUBLIC__/themes/jindong/images/nav_li.gif">
			
			  		<a href="http://vip.souho.cc/"  >极品源码</a> <img style="vertical-align:middle" src="__PUBLIC__/themes/jindong/images/nav_li.gif">
			
			  		<a href="flow.php"  >查看购物车</a> <img style="vertical-align:middle" src="__PUBLIC__/themes/jindong/images/nav_li.gif">
			
			  		<a href="quotation.php"  >报价单</a> <img style="vertical-align:middle" src="__PUBLIC__/themes/jindong/images/nav_li.gif">
			
			  			</div> 
            
<div  style="float:right; color:#acacac; padding-right:15px;">         
   <script type="text/javascript" src="__PUBLIC__/js/transport.js"></script><script type="text/javascript" src="__PUBLIC__/js/utils.js"></script>   <font id="ECS_MEMBERZONE">
  您好，欢迎您光临万联商城！<a href="__APP__/User/login">[请登录]</a><span>，新用户？</span><a style="color:#ff6600" href="__APP__/User/register">[免费注册]</a>
...
function show_menu(obj_s,obj){
  ...
  <p id="logo"><img style="float:left" src="__PUBLIC__/themes/jindong/images/logo.gif"/></a></p>
  
</div>
<div id="globalNav">
  <ul>
<li><a href="__APP__" class="cur">首页</a></li>
  <?php if(is_array($result)): foreach($result as $key=>$v): ?><li><a href="__APP__/ProductList/productList/id/<?php echo ($v["id"]); ?>" target="_blank"  ><?php echo ($v["tname"]); ?></a></li><?php endforeach; endif; ?>
 <li><a href="message.html"  >留言板</a></li>
 </ul>
</div>
<div id="globalSearch">
<img style="position:absolute; left:0;" src="__PUBLIC__/themes/jindong/images/search_box_l.gif">
<img  style="position:absolute; right:0;" src="__PUBLIC__/themes/jindong/images/search_box_r.gif">
...
<input type="image" src="__PUBLIC__/themes/jindong/images/search.gif" style="float:left" />
<span class="key2">
   热门搜索 ：
...
<a href="flow.php"><span>购物车中有<b>1</b>件商品</span>
  ...
  <li>
 <div class="f_l">
 <a class="img" href="goods.php?id=4761"><img src="__PUBLIC__/themes/jindong/images/201208/thumb_img/4761_thumb_G_1344186486336.jpg" style="width:50px; height:50px;" alt="产品1"></a>
...
<a href="flow.php?step=checkout"><img src="__PUBLIC__/themes/jindong/images/qujiesuan.gif"></a>
</div>
  </form>
...
<style type="text/css">
<!--
.age_box a{float: left; height:22px; line-height:22px; width:70px; background:url(__PUBLIC__/themes/jindong/images/biao6.gif) 0 center no-repeat; padding-left:10px;font-family:Arial, Helvetica, sans-serif;color:#333333}
-->
</style>
        ...
        <table border="0" >
          ...
          <tr>
            <td class="btnList">
              ...
              <input type="image" name="submit" src="__PUBLIC__/themes/jindong/images/btn_submit.gif" />
              <input type="image" src="__PUBLIC__/themes/jindong/images/btn_reset.gif" onclick="ECS_VOTEFORM.reset();" />
            </td>
          </tr>
        </table>
    </form>
...
<div id="emailList"  class="globalModule">
 ...
 <ul>
  ...
  <input type="image" src="__PUBLIC__/themes/jindong/images/btn_subscription.gif" onclick="add_email_list();" /> 
  <input type="image" src="__PUBLIC__/themes/jindong/images/btn_unsubscription.gif" onclick="cancel_email_list();" />
  </ul>
</div>
</div>
<div class="blank"></div>
...
<a  target="_blank" href="search.php?intro=hot">更多热卖>></a>	 
  ...
  <div class="clearfix">
  <!-- 热卖开始-->
  <?php if(is_array($hot)): foreach($hot as $key=>$v): ?><div class="item hot_item1">
      <p align="center" class="pic"><a target="_blank" href="__APP__/Product/detail/id/<?php echo ($v[0][pid]); ?>"><img style="width:130px; height:130px;margin:0 auto; text-align:center" src="__PUBLIC__/upload/<?php echo ($v[0][path]); ?>" alt="<?php echo ($v[0][pname]); ?>"/></a></p>
      <p align="center" class="name"><a target="_blank" href="__APP__/Product/detail/id/<?php echo ($v[0][pid]); ?>" title="产品5"><?php echo ($v[0][pname]); ?></a></p> 
      <p align="center" class="price">￥<?php echo ($v[0][price]); ?>元</p>
...
<div>
	...
	<DIV class="cxtj2" >
	   <?php if(is_array($new)): foreach($new as $key=>$v): ?><div class="item" style=" border-bottom:none; height:163px; padding:0; padding-top:1px;">
      <p class="pic"><a target="_blank" href="__APP__/Product/detail/id/<?php echo ($v[pid]); ?>"><img src="__PUBLIC__/upload/<?php echo ($v[path]); ?>" alt="产品5" /></a></p>
      <p class="name" ><a target="_blank" href="__APP__/Product/detail/id/<?php echo ($v[pid]); ?>" title="产品5"><?php echo ($v[pname]); ?><span></span></a></p>
      <p class="price">美智价：<span class="goodsPrice">￥<?php echo ($v[buyprice]); ?>元</span></p>
    </div><?php endforeach; endif; ?>
  </DIV>
...
{ 
document.write("<a href='#'><img style='float: left' src='__PUBLIC__/themes/jindong/images/ad_small.jpg'></a>"); 
} 
else { 
document.write("<a href='#'><img style='float: left' src='__PUBLIC__/themes/jindong/images/ad_big.jpg'></a>"); 
} 
</script> 
...
<dl>
<dt>
<img src="__PUBLIC__/themes/jindong/images/help_1.gif" />
...
<dl>
<dt>
<img src="__PUBLIC__/themes/jindong/images/help_2.gif" />
...
<dl>
<dt>
<img src="__PUBLIC__/themes/jindong/images/help_3.gif" />
...
<dl>
<dt>
<img src="__PUBLIC__/themes/jindong/images/help_4.gif" />
...
<dl>
<dt>
<img src="__PUBLIC__/themes/jindong/images/help_5.gif" />
...
<ul  class="line"><img src="__PUBLIC__/themes/jindong/images/serve_1.gif"></ul>
<ul  class="line"><img src="__PUBLIC__/themes/jindong/images/serve_2.gif"></ul>
<ul  class="line"><img src="__PUBLIC__/themes/jindong/images/serve_3.gif"></ul>
<ul ><img src="__PUBLIC__/themes/jindong/images/serve_4.gif"></ul>
</div>
</div>
<div class="blank"></div>
...
<p id="footerNav">
       ...
       | <script type="text/javascript" src="__PUBLIC__/js/dialog3.js"></script>
  </p>
...
<a href="http://www.miibeian.gov.cn"><img src="__PUBLIC__/themes/jindong/images/fot_1.gif"></a> <a href="#"><img src="__PUBLIC__/themes/jindong/images/fot_2.gif"></a> <a href="http://police.cnool.net/infoCategoryListAction.do?act=init"><img src="__PUBLIC__/themes/jindong/images/fot_3.gif"></a>
 </div>      
</div>  
  </div>
<script type="text/javascript" src="__PUBLIC__/js/my_lefttime.js"></script></body>
</html>