...
总计 <b>18</b>  个记录</span>
    ...
    <form name="compareForm" action="compare.php" method="post" onSubmit="return compareGoods(this);">
      ...
      <p class="pic">
        <a href="__APP__/Product/detail/id/<?php echo ($v["id"]); ?>"><img src="__ROOT__/Public/upload/<?php echo ($v["imagepath"]); ?>" alt="<?php echo ($v["title"]); ?>" /></a>
      </p>
      <div class="itemListInfo">
      <div style="float:left;">
        <p class="name">
          <a href="__APP__/Product/detail/id/<?php echo ($v["id"]); ?>" title="<?php echo ($v["title"]); ?>">
                        <?php echo ($v["title"]); ?>                      </a>
        ...
        <p class="btnList">
          <a href="javascript:collect(4779)"><img src="__ROOT__/Public/themes/jindong/images/buttons_coll.gif"></a> 
          <a href="__APP__/Cert/index/id/<?php echo ($v["id"]); ?>"><img src="__ROOT__/Public/themes/jindong/images/buttons_buy.gif"></a> 
          <a href="javascript:;" onClick="Compare.add(4779,'产品20')"><img src="__ROOT__/Public/themes/jindong/images/buttons_comp.gif"></a>
        </p>
        </div>
      </div>
