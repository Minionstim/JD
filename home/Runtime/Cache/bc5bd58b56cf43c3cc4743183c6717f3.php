...
<div class="blank"></div>
  ...
  <div class="flowBox">
        <form id="formCart" name="formCart" method="post" action="__APP__/Cert/add">
           <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#aacded">
            ...
            <?php if(is_array($arr)): foreach($arr as $key=>$v): ?><tr>
              <td bgcolor="#ffffff" align="left">
              	<img src="__ROOT__/Public/upload/<?php echo ($v["picname"]); ?>" width="50"/>
                 <a href="__APP__/Product/detail/id/<?php echo ($v["id"]); ?>" target="_blank" class="f6"><?php echo ($v["title"]); ?></a>
              </td>
              
              <td align="center" bgcolor="#ffffff">￥<?php echo ($v["userprice"]); ?>元</td>
              <td align="center" bgcolor="#ffffff">
               <input type="text" name="num[<?php echo ($v["id"]); ?>]" value="<?php echo ($v["num"]); ?>" size="4" class="inputBg" style="text-align:center " onkeydown="showdiv(this)"/>
              </td>
              <td align="center" bgcolor="#ffffff">￥<?php echo ($v[userprice] * $v[num]); ?>元</td>
              <td align="center" bgcolor="#ffffff">
                <a href="javascript:if (confirm('您确实要把该商品移出购物车吗？')) location.href='__APP__/Cert/delete/pid/<?php echo ($v["id"]); ?>'; " class="f6">删除</a>
              </td>
        ...
        <table width="99%" align="center" border="0" cellpadding="5" cellspacing="0" bgcolor="#aacded">
          <tr>
            <td bgcolor="#ffffff" style="padding:20px;0"><a href="__APP__/Product/index"><img style="vertical-align:middle;" src="__ROOT__/Public/themes/jindong/images/jixubuy.gif" /></a>&nbsp;&nbsp;&nbsp;&nbsp;

            
            <input style="vertical-align:middle;"  type="button" value="" class="clear_car" onclick="location.href='__APP__/Cert/clear'" />&nbsp;&nbsp;&nbsp;&nbsp;
            
            
            <input style="vertical-align:middle;" name="submit" type="submit" class="gengxin_car" value="" /></td>
            <td bgcolor="#ffffff" align="right" style="padding:20px;0"><a href="checkout.html"><img src="__ROOT__/Public/themes/jindong/images/checkout.gif" alt="checkout" /></a></td>
          </tr>
        </table>
         </form>
