...
<link rel="icon" href="animated_favicon.gif" type="image/gif" />
  ...
  <script type="text/javascript" src="__ROOT__/Public/js/common.js"></script><script type="text/javascript" src="__ROOT__/Public/js/user.js"></script><script type="text/javascript" src="__ROOT__/Public/js/transport.js"></script></head>
...
<div  style="float:right; color:#acacac; padding-right:15px;">         
   <script type="text/javascript" src="__ROOT__/Public/js/utils.js"></script>   <font id="ECS_MEMBERZONE">
...
<div class="usBox_in "  style="position:relative">
    ...
    <form action="__APP__/User/regsave" method="post" name="formUser" onsubmit="return register();" style="background:none"> <div class="blank"></div> <div class="blank"></div> <div class="blank"></div>
...
<td align="right" >密码问题答案</td>
          <td>
	  <input name="answer" type="text" size="25" class="inputBg" maxlengt='20'/>          </td>
        </tr>
		              <tr>
          <td>&nbsp;</td>
          <td><label>
        ...
        <tr>
          ...
          <input type="hidden" name="back_act" value="" />
           <input name="Submit" type="submit" value="" style=" width:136px; height:35px; border:none; background:url(__ROOT__/Public/themes/jindong/images/bnt_ur_reg.gif) no-repeat">
          </td>
        </tr>
        <tr>
          <td colspan="2">&nbsp;</td>
