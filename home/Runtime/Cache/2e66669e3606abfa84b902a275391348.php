...
<link rel="icon" href="animated_favicon.gif" type="image/gif" />
  <title><?php echo ($pArr["title"]); ?>-综合网购首选，正品行货，机打发票，售后上门取件，省钱又放心 - Powered by ECShop</title> 
<script type="text/javascript" src="__ROOT__/Public/js/common.js"></script><script type="text/javascript" src="__ROOT__/Public/themes/jindong/js/action.js"></script>
<script type="text/javascript" src="__ROOT__/Public/themes/jindong/js/mzp-packed-me.js"></script>
...
<div  style="float:right; color:#acacac; padding-right:15px;">         
   <script type="text/javascript" src="__ROOT__/Public/js/transport.js"></script><script type="text/javascript" src="__ROOT__/Public/js/utils.js"></script>   <font id="ECS_MEMBERZONE">
...
<a href="flow.php"><script type="text/javascript" src="__ROOT__/Public/js/transport.js"></script><span>购物车中有<b>1</b>件商品</span>
  <ul class="car_ul">
  <li>
 <div class="f_l">
 <?php if(is_array($imageArr)): foreach($imageArr as $key=>$v): ?><a class="img" href="goods.php?id=4761"><img src="__ROOT__/Public/uplaod/<?php echo ($v["picname"]); ?>" alt="产品1"></a>
 <a class="name" href="__APP__/Product/detail/id/<?php echo ($pArr["id"]); ?>"><?php echo ($pArr["title"]); ?></a><?php endforeach; endif; ?>
 </div>
 <div class="f_r">
 123456
<b>￥1000元×1</b> <br />
...
<div class="p_w" style="clear:both; overflow:hidden"></div>
  ...
  <h3><a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=296">服饰鞋帽</a> <code>&gt;</code> <a href="category.php?id=309">男装</a> <code>&gt;</code> <a href="category.php?id=310">衬衫T恤</a> <code>&gt;</code> 产品1</h3>
</div>
...
<div id="global_box" > 
  <ul id="history_list" class="boxCenterList">
    <ul class="clearfix"><li class="goodsimg"><a href="goods.php?id=4731" target="_blank"><img src="images/201001/thumb_img/4731_thumb_G_1262820447214.jpg" alt="AMD Athlon II ×2（速龙II双核）240盒装CPU（Socket AM3/2.8GHz/2M二级缓存/45纳米）A-FAN标志产品！45NM2.8高主频！套装更超值！" class="B_blue" /></a></li><li><a  class="name2" href="goods.php?id=4731" target="_blank" title="AMD Athlon II ×2（速龙II双核）240盒装CPU（Socket AM3/2.8GHz/2M二级缓存/45纳米）A-FAN标志产品！45NM2.8高主频！套装更超值！">AMD Athlon II ×2（速龙I...</a><font class="f1">￥419元</font><br /></li></ul><ul class="clearfix"><li class="goodsimg"><a href="goods.php?id=4746" target="_blank"><img src="images/201001/thumb_img/4746_thumb_G_1262821854338.jpg" alt="七彩虹（Colorful）C.G41 Twin V20主板（Intel G41/LGA 775）双内存智能主板!" class="B_blue" /></a></li><li><a  class="name2" href="goods.php?id=4746" target="_blank" title="七彩虹（Colorful）C.G41 Twin V20主板（Intel G41/LGA 775）双内存智能主板!">七彩虹（Colorful）C.G41 T...</a><font class="f1">￥400元</font><br /></li></ul><ul class="clearfix"><li class="goodsimg"><a href="goods.php?id=4761" target="_blank"><img src="images/201208/thumb_img/4761_thumb_G_1344186486336.jpg" alt="产品1" class="B_blue" /></a></li><li><a  class="name2" href="goods.php?id=4761" target="_blank" title="产品1">产品1</a><font class="f1">￥1000元</font><br /></li></ul><ul class="clearfix"><li class="goodsimg"><a href="goods.php?id=4762" target="_blank"><img src="images/no_picture.gif" alt="产品2" class="B_blue" /></a></li><li><a  class="name2" href="goods.php?id=4762" target="_blank" title="产品2">产品2</a><font class="f1">￥11111111元</font><br /></li></ul><ul id="clear_history"><a onclick="clear_history()">[清空]</a></ul>  </ul>
</div>
</div>
</div>
<script type="text/javascript">
...
<div class="blank"></div>      
    ...
    <div id="globalBigRight">
      ...
      <h2 class="name" style="text-align:center; font-size:16px; font-family:宋体; margin-bottom:8px; font-weight:bold; position: relative">产品1      <span style="color:#F00"></span>
            
      
      
      <div class="up_down">
             <a href="goods.php?id=4762"><img alt="prev" src="__ROOT__/Public/themes/jindong/images/up.gif" /></a>
                  </div>
      ...
      <div id="goodsInfo">
        <div id="itemPic">
          		<a target="_blank" href="__ROOT__/Public/upload/<?php echo ($imageArr["0"]["picname"]); ?>" onclick="window.open('gallery.php?id=4761'); return false;" id="zoom1" class="MagicZoom MagicThumb" rel="zoom-width: 550px; zoom-height: 350px; zoom-position:right">
      <img src="__ROOT__/Public/upload/<?php echo ($imageArr["0"]["picname"]); ?>" style="width:350px; height:350px;" />
	 </a>        
      ...
      <div class="gallery">
        <div id="demo">
          <div id="demo1" style="float:left">
           ...
           <a  href="__ROOT__/Public/upload/<?php echo ($v["picname"]); ?>"
     rel="zoom1" 
        rev="__ROOT__/Public/upload/<?php echo ($v["picname"]); ?>"
        title="">
        <img src="__ROOT__/Public/upload/<?php echo ($v["picname"]); ?>" alt="<?php echo ($pArr["title"]); ?>"  class="B_red" /></a>
      ...
      function clickRight() {
          ...
          <div class="b_zoom v_m"><a href="javascript:;" onclick="window.open('gallery.php?id=4761'); return false;"><img src="__ROOT__/Public/themes/jindong/images/zoom.gif" /> 点击查看大图</a></div>
        ...
        <form action="javascript:addToCart(4761)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
		 <ul class="line" >
               								
                        <li style="color:#999;">商品货号：123456</li>
                              <li>商品品牌：<a href="brand.php?id=241" >贝尔金</a></li>
                 
                        <li>市 场 价：<span class="marketPrice">￥1200元</span></li>
                        <li>美 智 价：<span class="goodsPrice" id="ECS_SHOPPRICE">￥1000元</span></li>
           
            <li>用户评价：<img src="__ROOT__/Public/themes/jindong/images/stars5.gif" alt="comment rank 5" /></li>
       ...
       <font class="f1">购买商品达到以下数量区间时可享受的优惠价格：</font><br />
			 <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#dddddd">
				<tr>
					...
					<td align="center" bgcolor="#FFFFFF" class="shop">￥900元</td>
				</tr>
					     </table>
      </li>
      ...
      <ul>
          <li id="itemBtnList">
          	 <a href="__APP__/Cert/add/pid/<?php echo ($pArr["id"]); ?>"><img src="__ROOT__/Public/themes/jindong/images/btn_addcart.gif" alt="" /></a>
              <a href="javascript:collect(4761)"><img src="__ROOT__/Public/themes/jindong/images/btn_addfav.gif" alt="" /></a><a href="user.php?act=affiliate&amp;goodsid=4761"><img src="__ROOT__/Public/themes/jindong/images/tuijian.gif" alt="" /></a>
     ...
     <div class="tab_box">
      ...
      <div id="com_h" class="padd_box">
        <blockquote>
        <p>就撒力进费德勒撒娇对方绝对是垃圾房。</p>        </blockquote>
        <blockquote>
    ...
    <table border="0">
      ...
      <tr>
        ...
        <td>
          ...
          <input type="image" src="__ROOT__/Public/themes/jindong/images/button_08.jpg" />
