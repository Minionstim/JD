...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <script type="text/javascript" src="__ROOT__/public/themes/jindong/js/action.js"></script>
    ...
    else
    {
      ...
      <div id="globalLeft">
        ...
        <div class="globalModule1">
          <h3 class="h32"><b>商品分类</b> <a target="_blank" href="__APP__/Search/index">全部分类>></a></h3>
          ...
          <div id="globalHistory" class="globalModule" >
            ...
            <div id="global_box" >
              <ul id="history_list" class="boxCenterList">
                <ul class="clearfix">
                  <li class="goodsimg"><a href="__APP__/Goods/index" target="_blank"><img src="__ROOT__/public/images/201001/thumb_img/4710_thumb_G_1262426233316.jpg" alt="联想（Lenovo）Y450A-TSI 14.0英寸笔记本电脑（T6600 2G 320G 512M独显 D刻 蓝牙 WIN7）" class="B_blue" /></a></li>
                  <li><a  class="name2" href="__APP__/Goods/index" target="_blank" title="联想（Lenovo）Y450A-TSI 14.0英寸笔记本电脑（T6600 2G 320G 512M独显 D刻 蓝牙 WIN7）">联想（Lenovo）Y450A-TSI ...</a><font class="f1">￥5099元</font><br /></li>
                </ul>
                <ul class="clearfix">
                  <li class="goodsimg"><a href="__APP__/Goods/index" target="_blank"><img src="__ROOT__/public/images/201001/thumb_img/4710_thumb_G_1262426233316.jpg" alt="联想（Lenovo）Y450A-TSI 14.0英寸笔记本电脑（T6600 2G 320G 512M独显 D刻 蓝牙 WIN7）" class="B_blue" /></a></li>
                  <li><a  class="name2" href="__APP__/Goods/index" target="_blank" title="联想（Lenovo）Y450A-TSI 14.0英寸笔记本电脑（T6600 2G 320G 512M独显 D刻 蓝牙 WIN7）">联想（Lenovo）Y450A-TSI ...</a><font class="f1">￥5099元</font><br /></li>
		...
		<div id="globalPromotion" class="globalModule">
		  ...
		  <div id="global_box">
		    <div class="itemGrid">
		      <div class="item" style="background: url(__ROOT__/public/themes/jindong/images/line_1.gif) repeat-x 0 bottom; padding:10px; width:190px; text-align:left;">
		        <a href="__APP__/Goods/index" target="_blank"><img style="width:50px; height:38px; float:left; margin-right:10px;" src="__ROOT__/public/images/201001/thumb_img/4713_thumb_G_1262436272956.jpg" alt="美的（midea）净化器KJ10F-NM" /></a>
		        <p class="name"><a href="__APP__/Goods/index" target="_blank" title="美的（midea）净化器KJ10F-NM">美的（midea）净化器KJ10F-NM</a></p>
      ...
      <div id="globalBigRight">
        <h2 class="name" style="text-align:center; font-size:16px; font-family:宋体; margin-bottom:8px; font-weight:bold; position: relative"><?php echo ($ob["goodstitle"]); ?> <span style="color:#F00">赠联想09款单肩包+鼠标!货量紧俏！</span>
          <div class="up_down">
            <a href="__APP__/Goods/index"><img alt="prev" src="__ROOT__/public/themes/jindong/images/up.gif" /></a>
          </div>
        </h2>
        <div id="itemAllInfo" class="globalModule">
          <div id="goodsInfo">
            <div id="itemPic">
              <a target="_blank" href="__ROOT__/public/images/201001/goods_img/4710_P_1262426233036.jpg" onclick="window.open('gallery.php?id=4710'); return false;" id="zoom1" class="MagicZoom MagicThumb" rel="zoom-width: 550px; zoom-height: 350px; zoom-position:right">
                <img src="__ROOT__/public/images/201001/goods_img/4710_G_1262426233567.jpg" style="width:350px; height:350px;" />
              </a>
                ...
                <div class="gallery">
                  <div id="demo">
                    <div id="demo1" style="float:left">
                      <ul>
                        <li>
                          <a  href="__ROOT__/public/images/201001/goods_img/4710_P_1262426233036.jpg" rel="zoom1" rev="__ROOT__/public/images/201001/goods_img/4710_P_1262426233036.jpg" title="">
                            <img src="__ROOT__/public/images/201001/thumb_img/4710_thumb_P_1262426233252.jpg" alt="联想（Lenovo）Y450A-TSI 14.0英寸笔记本电脑（T6600 2G 320G 512M独显 D刻 蓝牙 WIN7）" class="B_red" />
                          </a>
                        </li>
                      </ul>
                    </div>
            ...
            {
        var goodsCount = document.getElementById("goodsCount"+bookId).value;//当前要购买的产品的数量
        window.location = "__APP__/Action/index/goodsCount/"+goodsCount+"/goodsId/"+bookId;
          }
			     </script>
			   </div>
			   <div class="b_zoom v_m"><a href="javascript:;" onclick="window.open('gallery.php?id=4710'); return false;"><img src="__ROOT__/public/themes/jindong/images/zoom.gif" /> 点击查看大图</a></div>
			 </div>
		   </div>
		   <div id="itemInfoList">
       <foreach name="">
		     <form action="javascript:addToCart(4710)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
		       ...
		       <ul class="line" >
		         ...
		         <li>市 场 价：<span class="marketPrice">￥<?php echo ($ob["price"]); ?></span></li>
		         <li>美 智 价：<span class="goodsPrice" id="ECS_SHOPPRICE">￥<?php echo ($ob["new_price"]); ?>元</span></li>
		         <li>用户评价：<img src="__ROOT__/public/themes/jindong/images/stars5.gif" alt="comment rank 5" /></li>
		         <li>商品库存: <?php echo ($ob["stock"]); ?></li>
		         <li>购买数量：<input name="number" type="text" id="goodsCount<?php echo ($ob["goodsId"]); ?>" value="1" size="4" onblur="changePrice()" style="border:1px solid #ccc; width:40px; height:18px; vertical-align:middle; padding-left:3px; "/></li>
		         <li>商品总价：<?php echo ($ob["new_price"]); ?> <font id="ECS_GOODS_AMOUNT" class="goodsPrice"></font></li>
		       </ul>
		       <div style="clear:both"></div>
		       <ul>
		         <li id="itemBtnList"><img onclick="shopBook(<?php echo ($ob["goodsId"]); ?>)" title="123" src="__ROOT__/public/themes/jindong/images/btn_addcart.gif" alt="" />
		           <a href="javascript:collect(4710)"><img src="__ROOT__/public/themes/jindong/images/btn_addfav.gif" alt="" /></a><a href="user.php?act=affiliate&amp;goodsid=4710"><img src="__ROOT__/public/themes/jindong/images/tuijian.gif" alt="" /></a>
		         </li>
		       </ul>
		     </form>
		   </div>
		           ...
		           <tbody>
		             <tr valign="top">
		               <td align="left" width="100"><br />
		                 <img height="80" alt="" width="100" src="__ROOT__/public/images/201001/goods_img/4730_P_1262451940968.jpg" />
		               </td>
		             ...
		             <tr>
		               <td>
		                 <table cellspacing="0" cellpadding="0" border="0">
		                   <tbody>
		                     <tr>
		                       <td valign="top" align="left" width="97"><img height="81" alt="" width="87" src="__ROOT__/public/images/201001/goods_img/4730_P_1262451940968.jpg" /></td>
		   ...
		   <div id="globalComments">
		     ...
		     <div id="globalComments" class="com_v">
		       <table border="0" width="100%">
		         <tr>
		           <th width="500"><img src="__ROOT__/public/themes/jindong/images/biao3.gif" /> 匿名用户<span class="textTime">( 2012-05-29 15:09:03 )</span></th>
		           <td><img src="__ROOT__/public/themes/jindong/images/biao5.gif" />给出 <img src="__ROOT__/public/themes/jindong/images/stars5.gif" alt="" /> 评价</td>
		         </tr>
		         <tr>
		           <td colspan="2" class="commentsContent" style="padding-left:41px;">用几年就得了，还想用多久啊</td>
		         </tr>
		         <tr>
		           <td colspan="2" class="commentsLine"><img src="__ROOT__/public/themes/jindong/images/1px.gif"></td>
		         </tr>
		         <tr>
		           <th width="500"><img src="__ROOT__/public/themes/jindong/images/biao3.gif" /> 匿名用户<span class="textTime">( 2012-05-29 15:09:03 )</span></th>
		           <td><img src="__ROOT__/public/themes/jindong/images/biao5.gif" />给出 <img src="__ROOT__/public/themes/jindong/images/stars5.gif" alt="" /> 评价</td>
