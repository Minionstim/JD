...
function checkSearchForm()
{
      ...
      <div id="globalLeft">
        <div id="o-search" style="bottom:50px;">
          <div class="allsort">
            ...
            <div class="mc">
              <!-- 左上动态菜单 -->
              <?php if(is_array($typeinfo)): foreach($typeinfo as $k=>$v): ?><div class="item  fore" onMouseOver="this.className='item  fore  hover';"  onMouseOut="this.className='item  fore';">
                <span>
                  <h3><a href="category.php?id=355"><?php echo ($k); ?></a></h3>
                </span>
                <div class="i-mc">
                  ...
                  <div class="subitem">
                   <?php if(is_array($v)): foreach($v as $k=>$a): ?><dl  class="fore" >
                      <dt><a href="category.php?id=356"><?php echo ($k); ?></a></dt>
                     
                      <dd>
                       <?php if(is_array($a)): foreach($a as $s=>$q): ?><em><a href="category.php?id=363"><?php echo ($s); ?></a></em><?php endforeach; endif; ?>
        ...
        <div id="brandlist" class="globalModule" style="margin-top:355px;">
          ...
          <div id="brandlist" class="globalModule">
            ...
            <div id="global_box">
              <div style="clear:both"></div>
              <a href="__APP__/Brand/brand"><img class="brand_img" src="__ROOT__/public/data/brandlogo/1261024702576255018.jpg" alt="苹果 (1)" /></a>
              <a href="__APP__/Brand/brand"><img class="brand_img" src="__ROOT__/public/data/brandlogo/1261024702576255018.jpg" alt="苹果 (1)" /></a>
              <a href="__APP__/Brand/brand"><img class="brand_img" src="__ROOT__/public/data/brandlogo/1261024702576255018.jpg" alt="苹果 (1)" /></a>
              <a href="__APP__/Brand/brand"><img class="brand_img" src="__ROOT__/public/data/brandlogo/1261024702576255018.jpg" alt="苹果 (1)" /></a>
              <a href="__APP__/Brand/brand"><img class="brand_img" src="__ROOT__/public/data/brandlogo/1261024702576255018.jpg" alt="苹果 (1)" /></a>
              ...
              <a href="__APP__/Brand/brand"><img class="brand_img" src="__ROOT__/public/data/brandlogo/1261024702576255018.jpg" alt="苹果 (1)" /></a>
              <div style="clear:both"></div>
              <p class="more"><a href="__APP__/Brand/index"> 更多>></a></p>
            </div>
          </div>
          <div class="blank"></div>
          <table cellpadding="0" cellspacing="0" width="100%" style="margin:6px 0 0 0;">
            <tr>
              <td style="padding-bottom:5px;">
                <a href='#' target='_blank'><img src='__ROOT__/public/data/afficheimg/1284142905922427409.jpg' width='211' height='90' border='0' /></a>
              </td>
            </tr>
          </table>
          <div class="blank"></div>
          <div class="globalModule">
            ...
            <div style="border-bottom:1px solid #efefef; line-height:21px; padding-bottom:5px; margin:0 4px;">
              ...
              <a style=" color:#005ba0;" href="__APP__/Goods/index" title="aMD athlonII×2（速龙II双核）250盒装CPU（Socket aM3/3.0GHz/2M二级缓存/45纳米）" target="_blank">aMD athlonII×2（速龙II双核）250盒装CPU（S...</a>
              <div style="clear:both"></div>
              <a href="__APP__/Goods/index" title="aMD athlonII×2（速龙II双核）250盒装CPU（Socket aM3/3.0GHz/2M二级缓存/45纳米）" target="_blank">
                <img alt="aMD athlonII×2（速龙II双核）250盒装CPU（Socket aM3/3.0GHz/2M二级缓存/45纳米）" src="__ROOT__/public/images/201001/thumb_img/4738_thumb_G_1262821000118.jpg" style="width:50px; height:50px; float:left; padding-right:7px; " >
              </a>
              <a href="__APP__/Goods/index" title="aMD athlonII×2（速龙II双核）250盒装CPU（Socket aM3/3.0GHz/2M二级缓存/45纳米）" target="_blank">我现在的电脑就用这个，这里比我买的便宜。</a>
              <div style="clear:both"></div>
          ...
          <table cellpadding="0" cellspacing="0" width="100%" style="margin:6px 0 0 0;">
            <tr>
              <td style="padding-bottom:5px;">
                <a href='#' target='_blank'><img src='__ROOT__/public/data/afficheimg/1284142944453704804.gif' width='211' height='90' border='0' /></a>
              </td>
            </tr>
          </table>
          <div class="blank"></div>
          <table cellpadding="0" cellspacing="0">
            <tr>
              <td>
                <a href='#' target='_blank'><img src='__ROOT__/public/data/afficheimg/1284142966967642808.jpg' width='211' height='90' border='0' /></a>
              </td>
            </tr>
          </table>
          <div class="blank"></div>
        ...
        <div id="globalBigRight3">
          <div id="globalMiddle">
            <div id="promotionVideo" class="globalModule">
              <script type="text/javascript" src="__ROOT__/public/data/flashdata/dynfocus/cycle_image.js"></script>
            </div>
            <div id="globalBest" class="globalModule">
              ...
              <div id="show_hot_area" class="itemGrid">
                <div class="clearfix">
                <?php if(is_array($arr)): foreach($arr as $key=>$v): ?><div class="item hot_item1">
                    <p align="center" class="pic"><a target="_blank" href="__APP__/Goods/index/id/<?php echo ($v["goodsId"]); ?>"><img style="width:130px; height:130px;margin:0 auto; text-align:center" src="__ROOT__/public/images/201001/thumb_img/4692_thumb_G_1262412867503.jpg" alt="星辉遥控车模1：14超轻跑车兰博基尼橘色"/></a></p>
                    <p align="center" class="name"><a target="_blank" href="__APP__/Goods/index/id/<?php echo ($v["goodsId"]); ?>" title="星辉遥控车模1：14超轻跑车兰博基尼橘色"><?php echo ($v["goodstitle"]); ?></a></p>
                    <p align="center" class="price">￥<?php echo ($v["price"]); ?></p>
                  </div><?php endforeach; endif; ?>
                </div>
                <div class="clearfix">
                  <div class="item hot_item2">
                    <p align="center" class="pic"><a target="_blank" href="__APP__/Goods/index"><img  src="__ROOT__/public/images/201001/thumb_img/4690_thumb_G_1262412601118.jpg" alt="飞利浦（Philips）无尘袋吸尘器 FC8264" /></a></p>
                    <p align="center" class="name"><a target="_blank" href="__APP__/Goods/index" title="飞利浦（Philips）无尘袋吸尘器 FC8264">飞利浦（Philips）无尘袋吸尘器 F...</a></p>
                  </div>
                  <div class="item hot_item2">
                    <p align="center" class="pic"><a target="_blank" href="__APP__/Goods/index"><img  src="__ROOT__/public/images/201001/thumb_img/4690_thumb_G_1262412601118.jpg" alt="飞利浦（Philips）无尘袋吸尘器 FC8264" /></a></p>
                    <p align="center" class="name"><a target="_blank" href="__APP__/Goods/index" title="飞利浦（Philips）无尘袋吸尘器 FC8264">飞利浦（Philips）无尘袋吸尘器 F...</a></p>
                ...
                <div class="hot_item3box clearfix">
                  <div class="item hot_item2">
                    <a target="_blank" href="__APP__/Goods/index" title="美的(midea) MYR720T 台式温热型饮水机">美的(midea) MYR720T 台式...</a>
                  </div>
                  <div class="item hot_item2">
                    <a target="_blank" href="__APP__/Goods/index" title="美的(midea) MYR720T 台式温热型饮水机">美的(midea) MYR720T 台式...</a>
                  </div>
                ...
                <div class="clearfix">
                  <div class="item hot_item2">
                    <p align="center" class="pic"><a href="__APP__/Goods/index"><img  src="__ROOT__/public/images/201001/thumb_img/4701_thumb_G_1262417807509.jpg" alt="美的(midea) MYD718S-X 电子制冷饮水机" /></a></p>
                    <p align="center" class="name"><a href="__APP__/Goods/index" title="美的(midea) MYD718S-X 电子制冷饮水机">美的(midea) MYD718S-X ...</a></p>
                  </div>
                  <div class="item hot_item2">
                    <p align="center" class="pic"><a href="__APP__/Goods/index"><img  src="__ROOT__/public/images/201001/thumb_img/4701_thumb_G_1262417807509.jpg" alt="美的(midea) MYD718S-X 电子制冷饮水机" /></a></p>
                    <p align="center" class="name"><a href="__APP__/Goods/index" title="美的(midea) MYD718S-X 电子制冷饮水机">美的(midea) MYD718S-X ...</a></p>
                ...
                <div class="hot_item3box clearfix">
                  <div class="item hot_item2">
                    <a href="__APP__/Goods/index" title="长虹（CHaNGHONG）50英寸 高清 等离子电视PT50718(a)">长虹（CHaNGHONG）50英寸 高清...</a>
                  </div>
                  <div class="item hot_item2">
                    <a href="__APP__/Goods/index" title="多普达(Dopod) S505 CDMa智能手机 (黑)"><font color=#fe0000>多普达(Dopod) S505 CDMa...</font></a>
                  </div>
                  <div class="item hot_item2">
                    <a href="__APP__/Goods/index" title="长虹（CHaNGHONG）50英寸 高清 等离子电视PT50718(a)">长虹（CHaNGHONG）50英寸 高清...</a>
                  </div>
                      ...
                      <div>
                        <div class="cxtj2" >
                          <div class="item" style=" border-bottom:none; height:163px; padding:0; padding-top:1px;">
                            <p class="pic"><a target="_blank" href="__APP__/Goods/index"><img src="__ROOT__/public/images/201105/thumb_img/4760_thumb_G_1306040436494.jpg" alt="华为（HUaWEI）C8600 经典机器 直降70元！超值特价！" /></a></p>
                            <p class="name" ><a target="_blank" href="__APP__/Goods/index" title="华为（HUaWEI）C8600 经典机器 直降70元！超值特价！">华为（HUaWEI）C8600 经典机器...<span></span></a></p>
           ...
           <div class="blank"></div><div id="globalauction" class="globalModule">
             ...
             <div id="global_box">
               ...
               <div class="item" style="padding:8px 5px;">
                 <p class="pic"><a href="auction.php?act=view&amp;id=22"><img src="__ROOT__/public/images/201001/thumb_img/4693_thumb_G_1262412960593.jpg" alt="海尔(haier)吸尘器ZW1200—201" /></a></p>
         ...
         <table cellpadding="0" cellspacing="0">
           <tr>
             <td>
               <a href='affiche.php?ad_id=11&amp;uri=http%3a%2F%2Fwww.17558.net' target='_blank'><img src='__ROOT__/public/data/afficheimg/1306041417806904366.jpg' width='211' height='90'border='0' /></a>
             </td>
           </tr>
         </table>
         <div class="blank"></div>
       ...
       <div id="globalMiddle">
		 ...
		 <div  id="globalcat" >
		   ...
		   <div class="itemGrid">
		     <div class="in">
		       <div class="item">
		         <p class="pic"><a target="_blank" href="__APP__/Goods/index"><img src="__ROOT__/public/images/201001/thumb_img/4749_thumb_G_1262822060634.jpg" alt="技嘉（GIGaBYTE）Ga-Ma785GPMT-UD2H主板REV 1.0（aMD 785G/Socket aM3）" /></a></p>
		         <p class="name"><a target="_blank" href="__APP__/Goods/index" title="技嘉（GIGaBYTE）Ga-Ma785GPMT-UD2H主板REV 1.0（aMD 785G/Socket aM3）">技嘉（GIGaBYTE）Ga-Ma785...<span></span></a></p>
	         ...
	         <div class="itemGrid itemGrid2">
	           ...
	           <div class="line">
	             <div class="item">
	               ...
	               <p class="pic"><a target="_blank" href="__APP__/Goods/index"><img  src="__ROOT__/public/images/201001/thumb_img/4710_thumb_G_1262426233316.jpg" alt="联想（Lenovo）Y450a-TSI 14.0英寸笔记本电脑（T6600 2G 320G 512M独显 D刻 蓝牙 WIN7）" class="B_blue" /></a></p>
	               <p class="name">  <a target="_blank" href="__APP__/Goods/index" title="联想（Lenovo）Y450a-TSI 14.0英寸笔记本电脑（T6600 2G 320G 512M独显 D刻 蓝牙 WIN7）">联想（Lenovo）Y450a-TSI 14.0英寸笔记本电脑（T6600 2G 320G 512M独显 D刻 蓝牙 WIN7）</a></p>
	           ...
	           <div class="txt_list">
	             ...
	             <a target="_blank" href="__APP__/Goods/index" title="惠普（hp）4411s 14.0英寸笔记本电脑（T6570 2G 250G DVD刻录 512独显 无线 摄像头）">惠普（hp）4411s 14.0英寸笔记本电脑（T6570 2G 250G DVD刻录 512独显 无线 摄像头）</a>
	           </div>
	           <div class="txt_list">
	             <span class="no">2</span>
	             <a target="_blank" href="__APP__/Goods/index" title="惠普（hp）4411s 14.0英寸笔记本电脑（T6570 2G 250G DVD刻录 512独显 无线 摄像头）">惠普（hp）4411s 14.0英寸笔记本电脑（T6570 2G 250G DVD刻录 512独显 无线 摄像头）</a>
	   ...
	   <table cellpadding="0" cellspacing="0">
	     <tr>
	       <td>
	         <a href='affiche.php?ad_id=12&amp;uri=http%3a%2F%2Fwww.17558.net' target='_blank'><img src='__ROOT__/public/data/afficheimg/1306041433837845368.gif' width='211' height='90'border='0' /></a>
	       </td>
	     </tr>
	   </table>
	   <div class="blank"></div>
	         ...
	         <div id="com2_h">
	           <blockquote>
	             <div class="line">
	               <div class="item">
	                 <span class="no">1</span>
	                 <p class="pic"><a target="_blank" href="__APP__/Goods/index"><img  src="__ROOT__/public/images/201001/thumb_img/4718_thumb_G_1262450231383.jpg" alt="诺基亚（NOKIa）N86白色 3G手机 WCDMa/GSM800W卡尔蔡司镜头" class="B_blue" /></a></p>
	                 <p class="name">  <a target="_blank" href="__APP__/Goods/index" title="诺基亚（NOKIa）N86白色 3G手机 WCDMa/GSM800W卡尔蔡司镜头">诺基亚（NOKIa）N86白色 3G手机 WCDMa/GSM800W卡尔蔡司镜头</a></p>
	             ...
	             <div class="txt_list">
	               <span class="no">2</span>
	               <a target="_blank" href="__APP__/Goods/index" title="诺基亚（Nokia）N97i 3G手机 WCDMa/GSM （白色） 非移动定制机">诺基亚（Nokia）N97i 3G手机 WCDMa/GSM （白色） 非移动定制机</a>
	             </div>
	             <div class="txt_list">
	               <span class="no">2</span>
	               <a target="_blank" href="__APP__/Goods/index" title="诺基亚（Nokia）N97i 3G手机 WCDMa/GSM （白色） 非移动定制机">诺基亚（Nokia）N97i 3G手机 WCDMa/GSM （白色） 非移动定制机</a>
 ...
 <script type="text/javascript" src="__ROOT__/public/js/my_lefttime.js"></script>
 </body>
</html>