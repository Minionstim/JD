            ...
            <div id="globalAuctionList" class="globalModule">
              ...
              <div class="boxCenterList">
                <ul class="group clearfix">
                  <li class="f_l"><a href="__APP__/Auction/view"><img src="__ROOT__/public/images/201001/thumb_img/4739_thumb_G_1262821061445.jpg" border="0" alt="AMD Phenom II ×4（羿龙II四核）925盒装CPU（Socket AM3/2.8GHz/2M二级缓存/45纳米）" style="vertical-align: middle" /></a></li>
                  <li class="f_r">商品名称：<a href="__APP__/Auction/view" class="f5">AMD Phenom II ×4（羿龙II四核）925盒装CPU（Socket AM3/2.8GHz/2M二级缓存/45纳米）</a><br />活动状态：该拍卖活动正在进行中<br>起拍价：￥900元<br></li>
                </ul>
                <ul class="group clearfix">
                  <li class="f_l"><a href="__APP__/Auction/view"><img src="__ROOT__/public/images/201001/thumb_img/4739_thumb_G_1262821061445.jpg" border="0" alt="AMD Phenom II ×4（羿龙II四核）925盒装CPU（Socket AM3/2.8GHz/2M二级缓存/45纳米）" style="vertical-align: middle" /></a></li>
                  <li class="f_r">商品名称：<a href="__APP__/Auction/view" class="f5">AMD Phenom II ×4（羿龙II四核）925盒装CPU（Socket AM3/2.8GHz/2M二级缓存/45纳米）</a><br />活动状态：该拍卖活动正在进行中<br>起拍价：￥900元<br></li>
