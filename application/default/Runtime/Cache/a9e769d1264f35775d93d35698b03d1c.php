...
function checkSearchForm()
{
    ...
    else
    {
      ...
      <div style="width:80%; margin:0 AUTO">
        <form action="__APP__/Cart/ordersuccess" method="post" name="theForm" id="theForm" onsubmit="return checkOrderForm(this)">
          <div class="flowBox_title">
            <dl></dl><dt>订单详情</dt><dd></dd>
          </div>
          <div class="flowBox dingdan_all">
            <h6><span>商品列表</span><a href="__APP__/Cart/index" class="f6">修改</a></h6>
            <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#aacded">
              ...
              <tr>
                <td bgcolor="#ffffff">
                  <a href="__APP__/Goods/index" target="_blank" class="f6">华为（HUAWEI）C8600 经典机器 直降70元！超值特价！</a>
                </td>
            ...
            <div class="blank"></div>
            <h6><span>收货人信息</span><a href="__APP__/Cart/flow" class="f6">修改</a></h6>
            <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#aacded">
              <tr>
            ...
            <div align="center" style="margin:8px auto;">
              <input type="image" src="__ROOT__/public/themes/jindong/images/bnt_subOrder.gif" />
            </div>
          </div>
        </form>
      </div>
