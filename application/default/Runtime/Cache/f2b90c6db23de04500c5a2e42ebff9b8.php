      ...
      <div class="usBox clearfix" >
        ...
        <div class="usBox_in clearfix" style="position:relative">
          <div class="usBox_1 f_l">
            <form name="formLogin" action="__APP__/Login/login" method="post" onsubmit="return userLogin()">
              <table width="100%" border="0" align="left" cellpadding="3" cellspacing="5">
                ...
                <tr>
                  <td></td>
                  <td><a href="__APP__/Login/qpassword" class="f3">密码问题找回密码</a>&nbsp;&nbsp;&nbsp;<a href="__APP__/Register/password" class="f3">注册邮件找回密码</a></td>
                </tr>
              </table>
            </form>
          </div>
          <div class="usTxt" style="position:absolute; TOP:15PX; right:40PX;">
            ...
            <br />3. 享受会员积分制度
            <br />4. 订阅本店商品信息  <br />
            <a href="__APP__/Register/index"><img src="__ROOT__/public/themes/jindong/images/bnt_ur_reg.gif" /></a>
          </div>
        </div>
      </div>
      <div class="blank"></div>
