...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <script type="text/javascript" src="__ROOT__/public/js/user.js"></script>
    ...
    else
    {
      ...
      <div class="usBox clearfix"  style="position:relative">
        ...
        <div class="usBox_in "  style="position:relative">
          <form action="__APP__/Register/zhuce" method="post" name="formUser" onsubmit="return register();" style="background:none">
            <div class="blank"></div> 
            <div class="blank"></div> 
            <div class="blank"></div>
            <table width="100%"  border="0" align="left" cellpadding="5" cellspacing="3" style="background:none">
              ...
              <tr>
                ...
                <td>
                  <label>
                    <input name="agreement" type="checkbox" value="1" checked="checked" />我已看过并接受《<a href="__APP__/Register/article" style="color:blue" target="_blank">用户协议</a>》
                  </label>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td>&nbsp;</td>
                <td class="actionSub">
                  <a href="__APP__/Login/index">我已有账号，我要登录</a><br />
                  <a href="__APP__/Register/password">您忘记密码了吗？</a>
                </td>
              </tr>
            </table>
            <div class="blank"></div>
